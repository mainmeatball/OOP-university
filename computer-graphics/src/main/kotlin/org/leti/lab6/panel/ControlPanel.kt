...
import org.leti.lab6.listener.ControlPanelSpinnerListener
...
class ControlPanel(
    ...
    private val isColored: JCheckBox
    ...
    internal inner class CheckBoxListener : ActionListener {
        override fun actionPerformed(e: ActionEvent) {
            when (e.actionCommand) {
                ...
                COLORED_STR -> controlPanelListener.setColored(isColored.isSelected)
    ...
    companion object {
        ...
        private const val COLORED_STR = "Раскрасить грани"
    ...
    init {
        val buttonPanel = JPanel(GridLayout(3, 3))
        ...
        isColored = JCheckBox(COLORED_STR, false)
